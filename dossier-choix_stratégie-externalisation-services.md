...
> *Nous allons voir les différentes solutions qui existent sur le marché ainsi qu'une proposition de solution qui convient le mieux à nos besoins (voir expression des besoins).*

# 5.1 Comparatif Technique & Financier : VPS vs Public Cloud (Écosystème OVHcloud)
...
## 5.1 Option A : Le Serveur Privé Virtuel (VPS)
...
## 5.2 Option B : Le Public Cloud (Instance)
...
## 5.3 Analyse des Écarts & Décision pour le DSI
